...
with open(os.path.join(models_dir, 'class_indices.pkl'), 'wb') as f:
...
with open(os.path.join(comparison_dir, 'classification_report.txt'), 'w') as f:
    f.write(report)

# 混同行列の保存
conf_matrix = confusion_matrix(y_true, y_pred)
np.save(os.path.join(comparison_dir, 'confusion_matrix.npy'), conf_matrix)
